...
protected:
	...
	/**
	 * @brief Regenerates the stamina by the StaminaRegenStep amount for every StaminaRegenRate seconds
	 */
	UFUNCTION(BlueprintAuthorityOnly, BlueprintCallable, Category="Sprint|Base")
		void SprintStaminaRegenerate();
	 ...
	 */
	UPROPERTY(BlueprintReadOnly, Category="Sprint|Base")
